...
def image_upload_url(recipe_id):
    """Create and return an image upload id."""
...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            ...
            link = 'https://yahoo.com/randim.pdf',
            description = 'Sample recipe description'
        )
        payload = {
            'title': 'New Recipe Title',
            'link': 'https://google.com/random.pdf',
    ...
    def test_update_user_return_error(self):
        ...
        new_user = create_user(email='test1@example.com', password='test123')
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_new_ingredients(self):
        """"Test creating a reipe with new ingredients."""
        payload = {
...
class IamgeUploadTests(TestCase):
    ...
    def tearDown(self):
        """Execute to delete recipe and image created"""
